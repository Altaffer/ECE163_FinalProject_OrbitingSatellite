...
class MoonGravitationalModel():
    def __init__(self, initialNorth=VPC.MoonInitialNorth, initialEast=VPC.MoonInitialEast, initialDown=VPC.MoonInitialDown,
                 initialSpeed=VPC.MoonInitialSpeed, gravity = True):
        """
    ...
    def gravityForces(self, state):
        ...
        # the vector of unit lenght one pointing from the moon to earth
